...
.orb-1 { width: 500px; height: 500px; background: radial-gradient(circle, rgba(124, 58, 237, 0.3), transparent 70%); top: -100px; left: -100px; }
...
.badge { display: inline-flex; align-items: center; gap: 8px; padding: 8px 16px; background: rgba(124, 58, 237, 0.1); border: 1px solid rgba(124, 58, 237, 0.3); border-radius: 100px; color: #7c3aed; font-size: 13px; margin-bottom: 16px; }
...
.tool-card { background: rgba(15, 23, 42, 0.9); border: 1px solid rgba(124, 58, 237, 0.2); border-radius: 24px; padding: 32px; backdrop-filter: blur(20px); }
...
.tab:hover { border-color: rgba(124, 58, 237, 0.3); color: white; }
.tab.active { background: linear-gradient(135deg, rgba(124, 58, 237, 0.2), rgba(59, 130, 246, 0.2)); border-color: #7c3aed; color: white; }
...
.input-section textarea:focus, .output-section textarea:focus { border-color: #7c3aed; }
...
.arrow-btn { width: 50px; height: 50px; background: linear-gradient(135deg, #7c3aed, #3b82f6); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 24px; color: white; cursor: pointer; transition: transform 0.3s, box-shadow 0.3s; box-shadow: 0 4px 20px rgba(124, 58, 237, 0.4); }
.arrow-btn:hover { transform: scale(1.1); box-shadow: 0 6px 30px rgba(124, 58, 237, 0.5); }
...
.swap-btn:hover { color: white; border-color: #7c3aed; }
...
.action-btn:hover { color: white; border-color: rgba(124, 58, 237, 0.4); background: rgba(124, 58, 237, 0.1); }

.info-box { display: flex; gap: 16px; padding: 20px; background: rgba(124, 58, 237, 0.08); border: 1px solid rgba(124, 58, 237, 0.2); border-radius: 14px; margin-top: 28px; }
