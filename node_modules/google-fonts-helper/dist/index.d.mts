...
type GoogleFontsWeight = boolean | string | string[] | number | number[];
...
type FontStyle = GoogleFontsWeight;
type FontOptions = {
    display?: FontDisplay;
...
export { type DownloadOptions, Downloader, type DownloaderHooks, type Families, type FontDisplay, type FontInputOutput, type FontOptions, type FontStyle, type FontSubset, type GoogleFonts, constructURL, download, isValidURL, merge, parse };
