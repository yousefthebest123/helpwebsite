 ...
 */
  ...
  * 
  * @default "d8442604-eb14-491a-8f5e-5ef45384b41a"
 */
 buildId: string,
 ...
 */
  ...
  * 
  * @default ["**\/*.stories.{js,cts,mts,ts,jsx,tsx}","**\/*.{spec,test}.{js,cts,mts,ts,jsx,tsx}","**\/*.d.{cts,mts,ts}","**\/*.d.vue.{cts,mts,ts}","**\/.{pnpm-store,vercel,netlify,output,git,cache,data}","**\/node-compile-cache","**\/test-results","**\/*.sock",".nuxt/analyze",".nuxt","**\/-*.*"]
 */
 ignore: Array<string>,
