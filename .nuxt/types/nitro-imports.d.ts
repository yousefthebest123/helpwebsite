declare global {
  ...
  const connectToDatabase: typeof import('../../server/utils/mongodb').connectToDatabase
  ...
  const generateCode: typeof import('../../server/utils/auth').generateCode
...
declare global {
  ...
  // @ts-ignore
  export type { TokenPayload } from '../../server/utils/auth'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/youse/Downloads/HelperWebsite/helpwebsite/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/youse/Downloads/HelperWebsite/helpwebsite/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { generateToken, verifyToken, hashPassword, comparePassword, generateCode } from 'C:/Users/youse/Downloads/HelperWebsite/helpwebsite/server/utils/auth';
export { connectToDatabase, getDb } from 'C:/Users/youse/Downloads/HelperWebsite/helpwebsite/server/utils/mongodb';